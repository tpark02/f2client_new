    ...
    public partial class NodyWindow
    {
        ...
        public static KeyValuePair<ContextMenu, MethodInfo>[] GetContextMenuMethods(object obj)
        {
            ...
            foreach (MethodInfo method in methods)
            {
                ...
                {
                    if (method.DeclaringType != null) UnityEngine.Debug.LogWarning("Method " + method.DeclaringType.Name + "." + method.Name + " has parameters and cannot be used for context menu commands.");
                    continue;
                }

                if (method.IsStatic)
                {
                    if (method.DeclaringType != null) UnityEngine.Debug.LogWarning("Method " + method.DeclaringType.Name + "." + method.Name + " is static and cannot be used for context menu commands.");
                    continue;
                }
