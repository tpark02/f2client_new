    ...
    public partial class NodyWindow
    {
        ...
        public class VirtualPoint
        {
            ...
            public void CalculateRect()
            {
                ...
                if (Node == null)
                {
                    UnityEngine.Debug.Log("Cannot calculate the connection point Rect because the parent Node is null.");
                    return;
                }

                if (Socket == null)
                {
                    UnityEngine.Debug.Log("Cannot calculate the connection point Rect because the parent Socket is null.");
                    return;
                }
